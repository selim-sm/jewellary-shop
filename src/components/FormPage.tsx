            ...
            <div className="lg:flex items-center gap-10 border-2 bg-white rounded-xl p-8 h-fit">
              <div className="flex justify-center pb-5 lg:pb-0">
                <Link href={"/#product"}>
                  <img
                    src="/pic.png"
                    className="rounded-2xl w-[15rem] h-[20rem]"
                    alt="chose your product"
                  />
                </Link>
              </div>
              <div className="">
                ...
                <div className="pt-7 pb-5">
                  price <span className="font-bold text-2xl">₹00.000/-</span>{" "}
                  off - 00/-
                </div>
                <div className="flex justify-between items-center pb-5">
                  <div className="">Gross Weight</div>
                  <div className="font-bold">00 gram</div>
                </div>
