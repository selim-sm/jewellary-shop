...
const Colection5 = () => {
  ...
  const increment = () => {
    setCount(count + 1);
    setPrice(price + 75000);
  };

  const decrement = () => {
    setCount(count > 1 ? count - 1 : 1);
    setPrice(count > 1 ? price - 75000 : 75000);
  };
            ...
            <div className="lg:flex items-center gap-10 border-2 bg-white rounded-xl p-8 h-fit">
              ...
              <div className="">
                ...
                <div className="pt-7 pb-5">
                  price <span className="font-bold text-2xl">₹75000/-</span> off
                  - 4500/-
                </div>
                <div className="flex justify-between items-center pb-5">
                  <div className="">Gross Weight</div>
                  <div className="font-bold">50 gram</div>
                </div>
